...
# Check if Python is installed (for YARA rules installation)
if (-Not (Get-Command python -ErrorAction SilentlyContinue)) {
    Write-Output "Python is not installed. Please install Python 3.x from https://www.python.org."
    exit 1
}

# Install Python dependencies for YARA (valhallaAPI)
...
Write-Output "Downloading and updating Wazuh configuration file (ossec.conf)..."
